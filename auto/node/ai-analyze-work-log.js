...
4. 본문은 리스트(-) 형식으로 작성하고, 유사한 작업끼리 카테고리화 하세요.
5. 카테고리명이나 리스트명은 파일명이나 파일 위치가 아니고 핵심 작업을 표현해야 합니다.
6. 강조 표시를 사용하지 마세요.
7. .gitignore 파일은 분석에 반영하지 마세요.
8. 요약이나 분석 내용을 출력하지 마세요.
9. 파일 이름이나 파일 위치가 표시되어서는 안 됩니다.
