...
/* 리다이렉트 경로 */
export const localResetPasswordUrl = `http://localhost:5173${PATHS.ROOT.UPDATE.PASSWORD}`;
export const productResetPasswordUrl = `${import.meta.env.VITE_CLIENT_URL + PATHS.ROOT.UPDATE.PASSWORD}`;
