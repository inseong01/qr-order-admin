...
/**
 * 전체 주문 목록 조회용 Query Key
 */
export const ALL_ORDER_LIST_QUERY_KEY = ['allOrderList'];

/**
 * 특정 테이블 주문 목록 조회용 Query Key
 */
export const ORDER_LIST_QUERY_KEY = ['orderList'];

/**
 * 메뉴 카테고리 목록 조회용 Query Key
 */
export const MENU_CATEGORIES_QUERY_KEY = ['menuCategoryList'];

/**
 * 스토리지 이미지 수정/삭제용 Query Key
 *
 * - 조회는 async 아니어서 Query 캐싱 어려움
 */
export const STORAGE_IMAGE_QUERY_KEY = ['storageImage'];
