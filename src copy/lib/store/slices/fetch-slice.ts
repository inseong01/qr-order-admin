...
import { fetchOrderList } from '../../supabase/function/fetch-order';
import { TableDataArr, fetchTableList, fetchTableRequestList } from '../../supabase/function/fetch-table';
import { fetchCategoryMenu, fetchMenuImage, fetchMenuItem } from '../../supabase/function/fetch-menu';

import { AdminId, AllOrderList, InsertMenuCategoryList, MenuCategoryList, MenuList } from '../../../types/common';

import { createImgPath } from '../../../util/function/create-img-path';

import { UseBoundStore } from '../use-bound-store';

import { MsgType } from './submit-slice';
...
export interface UseFetchSlice {
  ...
  fetchOrderListStatus: ({ method, data }: { method: FetchMethod; data: AllOrderList }) => Promise<void>;
  fetchTableListData: ({
    method,
    dataArr,
  }: {
    method: FetchMethod;
    dataArr: TableDataArr<FetchMethod>;
  }) => Promise<void>;
  fetchUpdateAlertMsg: ({ method, id }: { method: FetchMethod; id: string }) => Promise<void>;
}
