...
test.describe('[예외/경계] 예외 및 경계 값 테스트', () => {
  ...
  test.describe('[예외] 데이터 미존재 안내', () => {
     ...
     */
    exceptionAPITest_S1('[예외] 메뉴 탭 데이터 없음 - 안내 문구 표시', async ({ page }) => {
      // 1. 메뉴 탭 등장 대기
     ...
     */
    exceptionAPITest_S1('[예외] 좌석 탭 데이터 없음 - 안내 문구 표시', async ({ page }) => {
      // 1. 좌석 탭 이동
     ...
     */
    exceptionAPITest_S1('[예외] 주문 탭 데이터 없음 - 안내 문구 표시', async ({ page }) => {
      // 1. 주문 탭 이동
  ...
  test.describe('[경계] 입력 값 유효성 검사', () => {
     ...
     */
    exceptionAPITest_S2('[경계] 메뉴 분류 추가 - 영문 입력 시 유효성 메시지', async ({ page }) => {
     ...
     */
    exceptionAPITest_S2('[경계] 메뉴 분류 수정 - 미선택 및 영문 입력 시 유효성 메시지', async ({ page }) => {
     ...
     */
    exceptionAPITest_S2('[경계] 메뉴 분류 삭제 - 미선택 시 유효성 메시지', async ({ page }) => {
     ...
     */
    exceptionAPITest_S2('[경계] 메뉴 생성 - 필수 입력 없이 추가 시 유효성 메시지', async ({ page }) => {
     ...
     */
    exceptionAPITest_S2('[경계] 메뉴 수정 - 필수 입력 없이 수정 시 유효성 메시지', async ({ page }) => {
  ...
  test.describe('[예외] 초기 API 요청 오류', () => {
     ...
     */
    exceptionAPITest_S3('[예외] 탭 진입 시 API GET 오류 - 오류 문구 표시', async ({ page }) => {
