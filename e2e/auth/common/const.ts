...
export const EMAIL_REDIRECT_URL = `https://${PROJECT_REF}.supabase.co/auth/v1/verify?token=${TEST_TOKEN_HASH}&type=recovery&redirect_to=http://localhost:5173/update/password`;
